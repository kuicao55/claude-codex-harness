---
name: harness-entry
description: "Command routing and session resume logic for claude-codex-harness. Use when processing any /harness: command invocation, especially /harness:resume."
---

# Harness Entry — Command Router and Session Resumption

This skill handles the entry point for all `/harness:` commands. It determines the current project state and routes to the correct phase.
...
> "All tasks in the plan appear complete but this milestone hasn't been marked passed. This may mean the Evaluator review wasn't completed."

Ask: "Would you like to:

1. Mark this milestone as passed and move to the next one
2. Re-run the Evaluator review on the existing code
